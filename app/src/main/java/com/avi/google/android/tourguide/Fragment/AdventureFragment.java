...
import com.avi.google.android.tourguide.Adapter.AdventureAdapter;
import com.avi.google.android.tourguide.Data.AdventureData;
...
public class AdventureFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getContext() != null) {
            ...
            recyclerView.setAdapter(new AdventureAdapter(AdventureData.fetchAdventureData(getContext()), getContext()));
        }
    }
}